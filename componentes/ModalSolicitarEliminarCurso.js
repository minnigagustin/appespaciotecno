...
export const ModalSolicitarEliminarCurso = (props) => {
    ...
    <View style={{flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center',
        ...
        <View style={styles.container}>
            ...
            <Text style={styles.text_solicitar}> Si confirmas salir del curso se eliminara de tu base de datos y no podras volver a ingresar.</Text>
           
            <View style={styles.container_botones}>
              <TouchableOpacity style={styles.boton_cancelar} onPress={props.restore}>
                <Text style={styles.texto_style}>Cancelar</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.boton_desvincular} onPress={props.restore}>
