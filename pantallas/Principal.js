...
export default function Principal({ route }) {
    ...
    axiosLoggedInConfig()
      ...
      .then((res) => {
        ...
        if (cursos.length) {
          ...
          Alert.alert(
            "Ups! No tenemos cursos",
            "Lo sentimos, prueba con otra fecha y disfruta de Espacio Tecno ;)"
          );
        }
  ...
  const onClickHora = () => {
    ...
    const curso =
      BASE_URL +
      "horarioscursobyfechaandcursoid/?id_curso=" +
      id +
      "&fecha=" +
      fechadate;
    axiosLoggedInConfig()
  ...
  const onClickRegistrado = () => {
    ...
    axiosLoggedInConfig()
      .post(curso, { comision: comisionid })
      .then((res) => {
      ...
      .catch((err) => {
        Alert.alert(
          "Ey! Ya estas inscripto",
          "Ups, no te pudimos volver a inscribir ya que te inscribiste anteriormente"
        );
      });
  };
  ...
  dataFechas.forEach((val) => {
    markedDatesCursosArray[val] = {
      selected: true,
      selectedColor: "#00789d",
    ...
    <ScrollView style={{ backgroundColor: "white" }}>
      ...
      >
        <View style={styles.centeredView}>
          ...
          >
            ...
            >
              Turno{" "}
              {horaseleccionada > "09:00:00" && horaseleccionada < "13:00:00"
                ? "mañana"
                : "tarde"}{" "}
              |{" "}
              <Text style={{ fontWeight: "bold" }}>
                {moment(horaseleccionada, "H:mm:ss").format("HH:mm")}Hs
              </Text>
            </Text>
            <Pressable
              style={[styles.button, styles.buttonClose]}
              onPress={() => setModalConfirmado(false)}
            >
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            >
              {diasdictado.find(
                (cat) =>
                  cat.dia_comision.horario_inicio > "01:00:00" &&
                  cat.dia_comision.horario_inicio < "13:00:00"
              ) && (
                  ...
                  {diasdictado
                    ...
                    .map((item, i) => {
                      return (
                        <TouchableOpacity
                          onPress={() => {
                            setSelectHorario(item.comision_id),
                              sethoraseleccionada(
                                item.dia_comision.horario_inicio
                              );
                          }}
                        >
                          <Text
              ...
              {diasdictado.find(
                (cat) =>
                  cat.dia_comision.horario_inicio > "12:59:00" &&
                  cat.dia_comision.horario_inicio < "23:59:00"
              ) && (
                <View style={{ marginHorizontal: 10 }}>
                  <Text
                    style={{
          ...
          <View style={styles.modalView}>
            ...
            <Pressable
              style={[
                ...
                styles.buttonClose,
                {
                  backgroundColor: catg > 0 ? "#0086bf" : "rgba(0, 0, 0, 0.15)",
                },
              ]}
              onPress={() => {
                onClickHora();
      ...
      <View>
        ...
        >
          ...
          >
            Bienvenid@ {perfil ? perfil.nombre : "Registrate"}!
          </Text>
          <Text
            style={{
