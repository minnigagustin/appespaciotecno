      ...
      <Modal visible={props.state}
        ...
        alignItems: 'center',}}>
          ...
          <View style={styles.container}>
              ...
              <FontAwesome name="thumbs-o-up" size={90} marginBottom={20} color={"#90C641"}/>
              <Text style={styles.text_eliminado}> Curso eliminado con éxito</Text>
              </View>

              <View style={styles.container_salir}>
                <TouchableOpacity style={styles.boton_style} onPress={props.restore}>
